...
function Premium({ handlePremium }) {
  const {
    register,
    handleSubmit,
    formState: { errors },
          ...
          <div className="containers">
            ...
            <div className="texsub1">
              <h5>
                ...
                <span className="ss">Gold subscription on price of 100Rwf</span>
              </h5>
            </div>
            <form onSubmit={handleSubmit(onsubmit)}>
                ...
                <div className="col">
                  ...
                  {/* <div className="inputBox">
                    ...
                    >
                      ...
                      <option value="gold">1 year</option>
              ...
              <div className="pbtn">
                ...
                <button className="close-btn" onClick={handlePremium}>
                  Close
                </button>
              </div>
            </form>
